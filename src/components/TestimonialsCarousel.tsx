...
const testimonials = [
  ...
  { name: "Sarah Mitchell", role: "HR Director, Global Staffing Corp", country: "Australia", flag: "au", rating: 5, text: "We've placed over 200 skilled workers through VisaHOBe's recruitment services. Their Subclass 482 expertise and end-to-end support are unmatched in the industry." },
  { name: "Ahmed Al-Mansour", role: "Operations Manager", country: "Saudi Arabia", flag: "sa", rating: 5, text: "Professional, reliable, and incredibly thorough. VisaHOBe handled our entire workforce visa process from screening to placement. Highly recommend their services." },
  { name: "Elena Petrovic", role: "Talent Acquisition Lead", country: "Serbia", flag: "rs", rating: 4, text: "As an emerging European gateway, finding a recruitment partner who understands Serbia's visa landscape was challenging — until we found VisaHOBe. Outstanding service." },
  { name: "Tanvir Hossain", role: "Electrical Engineer", country: "Russia", flag: "ru", rating: 5, text: "From document preparation to post-arrival guidance, VisaHOBe supported me at every step. I'm now working in Moscow thanks to their dedicated team." },
  { name: "Kamal Uddin", role: "IT Specialist", country: "Cambodia", flag: "kh", rating: 5, text: "I was worried about the complexity of international work visas, but VisaHOBe simplified everything. Their consultancy approach is transparent and trustworthy." },
];
