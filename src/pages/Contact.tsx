        ...
        <div className="container-main grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <AnimatedSection>
            ...
            <div className="mt-8 rounded-xl overflow-hidden shadow-lg border border-border">
              <iframe
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3988.8!2d103.849!3d1.286!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zMcKwMTcnMTAuMCJOIDEwM8KwNTAnNTYuMCJF!5e0!3m2!1sen!2ssg!4v1"
                width="100%"
                height="250"
                style={{ border: 0 }}
                allowFullScreen
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <input
                    ...
                    className="px-4 py-3 rounded-lg bg-muted/50 text-foreground border border-border focus:outline-none focus:border-primary placeholder:text-muted-foreground/60"
                  />
                  <input
                    type="email"
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  ...
                  <select
                    ...
                    className="px-4 py-3 rounded-lg bg-muted/50 text-foreground border border-border focus:outline-none focus:border-primary"
                  >
                ...
                <textarea
                  ...
                  className="w-full px-4 py-3 rounded-lg bg-muted/50 text-foreground border border-border focus:outline-none focus:border-primary resize-none placeholder:text-muted-foreground/60"
                />
                <button
                  type="submit"
                  className="w-full px-8 py-3.5 bg-primary text-primary-foreground font-semibold rounded-full hover:bg-highlight-hover transition-colors flex items-center justify-center gap-2"
                >
