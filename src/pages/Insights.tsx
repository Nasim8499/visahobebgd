...
const articles = [
  ...
  { date: "Mar 28, 2026", tag: "Analysis", title: "The Post-H-1B Lottery Playbook: Exploring Visa Alternatives for Your Global Solutions", desc: "The H-1B visa lottery results are in. For those not selected, discover alternative pathways including O-1, L-1, and E-2 visa categories.", image: servicesManpower },
      ...
      <section className="relative py-20 md:py-28 bg-nav overflow-hidden">
        <div className="relative z-10 container-main px-4 text-center">
          <motion.h1
            ...
            className="font-display text-3xl md:text-5xl font-bold text-nav-foreground mb-4"
          >
            Insights
          </motion.h1>
          <motion.p
            ...
            className="text-nav-foreground/70 max-w-2xl mx-auto"
          >
      ...
      <section className="section-padding bg-background">
        <div className="container-main">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {articles.map((a, i) => (
              <AnimatedSection key={i} delay={i * 0.1}>
                <motion.div
                  whileHover={{ y: -6 }}
                  className="bg-card rounded-xl overflow-hidden shadow-lg border border-border group h-full flex flex-col"
                >
                  ...
                  <div className="p-6 flex flex-col flex-1">
                    ...
                    <h3 className="font-display font-bold text-card-foreground mb-2 leading-snug">{a.title}</h3>
          ...
          <div className="text-center mt-12">
            <button className="px-8 py-3 border-2 border-primary text-primary font-semibold rounded-full hover:bg-primary hover:text-primary-foreground transition-colors">
              All Insights
            </button>
          </div>
        </div>
        ...
        <div className="container-main grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <AnimatedSection>
            <h2 className="font-display text-3xl md:text-4xl font-bold text-foreground mb-6">
              Global Talent Strategy Toolkit
            </h2>
            <p className="text-muted-foreground leading-relaxed mb-6">
              For organizations navigating complex immigration landscapes, our toolkit provides comprehensive guidance on alternative visa pathways, compliance strategies, and workforce planning frameworks.
            </p>
            <Link to="/contact" className="inline-flex items-center gap-2 px-8 py-3 bg-primary text-primary-foreground font-semibold rounded-full hover:bg-highlight-hover transition-colors">
