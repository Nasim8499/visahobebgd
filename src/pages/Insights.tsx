...
const articles = [
  { date: "Apr 10, 2026", tag: "Policy", title: "Apr 2026 DOL PERM & Prevailing Wage Processing Updates", desc: "The DOL has released updated processing times for PERM labor certifications and prevailing wage determinations.", image: servicesVisa },
  { date: "Apr 5, 2026", tag: "Europe", title: "The EU Entry-Exit System: What Travelers Should Know", desc: "The EU's EES will collect biometric data from third-country nationals. Learn about the implications.", image: aboutTeam },
  { date: "Mar 28, 2026", tag: "Analysis", title: "The Post-H-1B Lottery Playbook: Exploring Visa Alternatives", desc: "For those not selected, discover alternative pathways including O-1, L-1, and E-2 visa categories.", image: servicesManpower },
  ...
  { date: "Mar 15, 2026", tag: "Australia", title: "Australia Subclass 482 Visa Changes: What Employers Need to Know", desc: "The Department of Home Affairs announces changes to skilled occupation lists.", image: aboutTeam },
  { date: "Mar 10, 2026", tag: "Strategy", title: "Building a Resilient Global Talent Strategy in 2026", desc: "Key trends and strategies for organizations looking to optimize their international workforce.", image: servicesManpower },
];
    ...
    <div className="pt-14 pb-16 lg:pb-0">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {articles.map((a, i) => (
              <AnimatedSection key={i} delay={i * 0.1}>
                <motion.div whileHover={{ y: -6 }} className="glass-card rounded-2xl overflow-hidden group h-full flex flex-col hover:border-primary/20 transition-all">
                  ...
                  <div className="p-6 flex flex-col flex-1">
                    <div className="flex items-center gap-2 mb-3">
                      <span className="px-2.5 py-1 text-xs font-semibold bg-gradient-to-r from-primary/15 to-accent/15 text-primary rounded-full">{a.tag}</span>
      ...
      <section className="section-padding bg-section-alt">
        <div className="container-main grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <AnimatedSection>
            <h2 className="font-display text-3xl md:text-4xl font-bold text-foreground mb-6">Global Talent Strategy <span className="text-gradient">Toolkit</span></h2>
            ...
            <Link to="/contact" className="inline-flex items-center gap-2 px-8 py-3 bg-gradient-to-r from-primary to-primary/80 text-primary-foreground font-semibold rounded-xl hover:shadow-lg hover:shadow-primary/25 transition-all">
          ...
          <AnimatedSection delay={0.2}>
            <div className="relative">
              ...
              <img src={aboutTeam} alt="Strategy toolkit" className="rounded-2xl shadow-2xl w-full relative" loading="lazy" />
            </div>
          </AnimatedSection>
        </div>
      </section>
